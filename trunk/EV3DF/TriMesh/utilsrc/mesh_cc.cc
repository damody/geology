...
void find_comps(TriMesh *in, std::vector<int> &comps, std::vector<int> &compsizes)
{
...
void sort_comps(std::vector<int> &comps, std::vector<int> &compsizes)
{
	if (compsizes.size() < 1)
		return;
...
void print_comps(const std::vector<int> &comps, const std::vector<int> &compsizes,
		 int morethan, int lessthan, int total)
{
	printf("%d connected components total.\n", compsizes.size());
...
// the mesh.
void select_comp(TriMesh *in, const std::vector<int> &comps, int whichcc)
{
...
// the mesh.
void select_comps_by_size(TriMesh *in, const std::vector<int> &comps,
